...
Sua conta no Fluxora para ${workspaceName} foi criada com sucesso.
...
Fluxora
Controle financeiro operacional para pequenas empresas de serviço.`;
  ...
  <html lang="pt-BR">
    <head>
      ...
      <title>Confirme seu acesso ao Fluxora</title>
    </head>
              ...
              <tr>
                <td style="padding:32px 32px 24px;background-color:#111827;color:#ffffff;">
                  ...
                  <p style="margin:12px 0 0;font-size:15px;line-height:1.7;color:#d4d4d8;">
                    Seu ambiente no Fluxora foi criado. Falta só validar o e-mail para liberar a entrada.
                  </p>
                </td>
              </tr>
              <tr>
                <td style="padding:32px;">
                  ...
                  <p style="margin:0 0 16px;font-size:16px;line-height:1.7;">
                    A conta de <strong>${safeWorkspaceName}</strong> foi criada com sucesso.
                  </p>
                  <p style="margin:0 0 24px;font-size:16px;line-height:1.7;">
                    Para ativar seu acesso, clique no botão abaixo.
                  </p>
