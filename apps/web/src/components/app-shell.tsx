...
export function AppShell({ title, section = "Fluxora", children }: AppShellProps) {
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset className="min-h-svh overflow-x-clip bg-background md:overflow-hidden md:border md:border-border/70 md:bg-background md:shadow-[0_18px_42px_rgba(8,16,24,0.08)]">
        <header className="sticky top-0 z-30 hidden shrink-0 items-center border-b border-border/70 bg-background/96 backdrop-blur-lg md:flex">
