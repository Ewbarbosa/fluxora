...
export function AppShell({ title, section = "Fluxora", children }: AppShellProps) {
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset className="min-h-svh overflow-x-clip bg-background md:overflow-hidden md:border md:border-black/6 md:bg-[color:var(--app-panel)] md:shadow-[0_20px_56px_rgba(15,23,32,0.1)]">
        <header className="sticky top-0 z-30 hidden shrink-0 items-center border-b border-black/5 bg-[color:var(--app-panel-strong)]/96 backdrop-blur-lg md:flex">
