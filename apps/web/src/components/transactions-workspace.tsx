    ...
    <>
      <div className="space-y-6 p-1 pt-0 md:p-4 md:pt-0">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="max-w-2xl text-sm text-[color:var(--app-hero-muted)]">
                    Controle de caixa, atraso e recorrência com leitura rápida no celular e ação direta na mesma tela.
                  </p>
                </div>
              </div>
              <Button onClick={openCreateModal} className="rounded-2xl border-0 bg-[color:var(--app-hero-button-solid)] text-[color:var(--app-hero-button-solid-foreground)] hover:bg-[color:var(--app-hero-button-solid)]/90">
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {loading ? (
                Array.from({ length: 4 }).map((_, index) => (
                  <div key={index} className="rounded-[1.35rem] bg-[color:var(--app-hero-surface)] p-4">
                    <Skeleton className="h-4 w-20 bg-[color:var(--app-hero-button)]" />
                    <Skeleton className="mt-3 h-8 w-28 bg-[color:var(--app-hero-button)]" />
                  </div>
                ))
              ) : (
                <>
                  <div className="rounded-[1.35rem] border border-[color:var(--app-hero-border)] bg-[color:var(--app-hero-surface)] p-4 backdrop-blur">
                    <p className="text-sm text-[color:var(--app-hero-muted)]">Receitas</p>
                    <p className="mt-2 text-2xl font-semibold text-emerald-100 dark:text-emerald-200">{formatMoney(summary?.totalIncome ?? 0)}</p>
                  </div>
                  <div className="rounded-[1.35rem] border border-[color:var(--app-hero-border)] bg-[color:var(--app-hero-surface)] p-4 backdrop-blur">
                    <p className="text-sm text-[color:var(--app-hero-muted)]">Despesas</p>
                    <p className="mt-2 text-2xl font-semibold text-rose-100 dark:text-rose-200">{formatMoney(summary?.totalExpense ?? 0)}</p>
                  </div>
                  <div className="rounded-[1.35rem] border border-[color:var(--app-hero-border)] bg-[color:var(--app-hero-surface)] p-4 backdrop-blur">
                    <p className="text-sm text-[color:var(--app-hero-muted)]">Saldo</p>
                    <p className="mt-2 text-2xl font-semibold">{formatMoney(summary?.balance ?? 0)}</p>
                  </div>
                  <div className="rounded-[1.35rem] border border-[color:var(--app-hero-border)] bg-[color:var(--app-hero-surface)] p-4 backdrop-blur">
                    <p className="text-sm text-[color:var(--app-hero-muted)]">Vencidos</p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {loading ? (
            Array.from({ length: 4 }).map((_, index) => (
              <Card key={index} className="rounded-[1.35rem] border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
            ...
            <>
              <Card className="rounded-[1.35rem] border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
        ...
        <Card className="rounded-[1.5rem] border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 md:grid-cols-4">
              <div className="rounded-[1.15rem] border border-[color:var(--app-soft-border)] bg-[color:var(--app-surface)] p-3">
            ...
            <div className="space-y-2">
              {(notifications?.items ?? []).slice(0, 5).map((item) => (
                <div key={item.id} className="flex items-center justify-between rounded-[1.15rem] border border-[color:var(--app-soft-border)] bg-[color:var(--app-surface)] p-3 text-sm">
                  <div>
        ...
        <Card className="rounded-[1.5rem] border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4 rounded-[1.35rem] border border-[color:var(--app-soft-border)] bg-[color:var(--app-surface)] p-4">
              ...
              <div className="grid gap-3 md:grid-cols-3">
                ...
                <div className="flex items-end gap-2">
                  <Button variant="outline" className="w-full rounded-xl bg-background" onClick={applyCustomRange}>
            ...
            <div className="space-y-5">
              {loading ? (
                Array.from({ length: 3 }).map((_, index) => (
                  <div key={index} className="overflow-hidden rounded-[1.35rem] border border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
                ...
                groupedTransactions.map((group) => (
                  <div key={group.label} className="overflow-hidden rounded-[1.35rem] border border-[color:var(--app-shell-border)] bg-[color:var(--app-surface-strong)] shadow-[var(--app-card-shadow)]">
                    <div className="border-b bg-muted/30 px-4 py-4">
                      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="grid gap-2 sm:grid-cols-3">
                          <div className="rounded-xl border border-[color:var(--app-soft-border)] bg-background px-3 py-2 text-sm">
                    ...
                    <div className="space-y-3 p-3 md:hidden">
                      {group.items.map((item) => {
                        ...
                        return (
                          <div key={item.id} className="rounded-[1.25rem] border border-[color:var(--app-soft-border)] bg-[color:var(--app-surface-strong)] p-4 shadow-[var(--app-card-shadow-soft)]">
